...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libnvshmem-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libnvshmem-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add libnvshmem-dev libnvshmem-static libnvshmem3 nvshmem4py
# for installing globally
pixi global install libnvshmem-dev libnvshmem-static libnvshmem3 nvshmem4py
```
...
It is possible to list all of the versions of `libnvshmem-dev` available on your platform:
...
```
pixi search libnvshmem-dev --channel conda-forge
```
